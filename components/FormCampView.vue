    ...
    <template #content>
        ...
        <div class="stepform_actions rounded mb-5" v-if="activeStep != steps.length">
            <div class="row g-3 justify-content-end mt-4 p-3 pt-0">
                <div class="col-md-4">
                    <button @click.prevent="activeStep = activeStep - 1" v-if="activeStep > 1" class="btn btn-outline btn-outline-secondary btn-rounded w-100">Назад</button>
                </div>
                <div class="col-md-4">
                </div>
                <div class="col-md-4">
                    <button @click.prevent="nextStep" class="btn btn-primary btn-rounded w-100">Далее</button>
                </div>
            </div>
        </div>
    </template>
...
<script>
import FormAthletesSetCamp from '~/components/forms/FormAthletesSetCamp.vue'
import FormAcceptChecks from '~/components/forms/FormAcceptChecks.vue'
import FormCampLastStep from '~/components/forms/FormCampLastStep.vue'
import FormContactsFieldgroupCamp from '~/components/forms/FormContactsFieldgroupCamp.vue'
