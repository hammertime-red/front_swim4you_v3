<template>
    ...
    <div class="content_box p-4 mb-4">
        ...
        <div class="row g-4">
            <div v-if="postdata.type == 'camp' && postdata.name && postdata.id" class="col-md-3 small">
                <p class="text-muted mb-1">Смена</p>
                <router-link :to="`/stage/${postdata.id}`" class="mb-0 font-bold">
                    {{postdata.name}}
                </router-link>
            </div>
            <div v-if="postdata.type == 'master_class' && postdata.name && postdata.id" class="col-md-3 small">
            ...
            <div v-if="postdata.type == 'master_class' && postdata.dates" class="col-md-3 small">
    ...
    <div class="content_box p-4 mb-4">
        ...
        <div class="data_table">
            <table class="table table-hover table-responsive">
                <thead>
                    <tr>
                        <th scope="col font-bold small">ФИО</th>
                        <th scope="col font-bold small">Дата рождения</th>
                        <th scope="col font-bold small">Пол</th>
                        <th scope="col font-bold small">Разряд</th>
                        <th scope="col font-bold small">Гражданство</th>
                        <th scope="col font-bold small" class="text-end">Документы</th>
                    </tr>
                </thead>
                <tbody>
